...
import transform from '../transformers/blog.trasnformer';
import {
  Blog,
  BlogCreateInput,
  BlogUpdateInput,
...
// create a blog on the database convert the result to the blog type and send it back to the controller
...
// fetch all the blogs from database convert it to the Blog typr and send it back to the controller
